...
Before any code exists — before the first endpoint, before the first database table, before the system architecture even takes shape — there is a crucial phase that determines whether a project will succeed or collapse under its own confusion.

In my case, I wasn’t just a participant in this phase.
...
- Communication with the client’s stakeholders
- Alignment with my manager
- Coordination between my company and the client’s company
- Writing briefs
...
And this is important because this part of the job is often invisible, but it’s where real engineering begins.

It’s the moment where ideas become structure.
Where confusion becomes clarity.
Where “we need this” becomes “we can build this”.

In the next sections, I’ll break down every step of the process I personally carried out:

🗣️ Communication & requirement gathering.
📝 Documentation (Confluence, Azure)
📌 Task organisation & workflow (Jira)
🤝 Coordination between teams
✔️ Validation & approval
🧱 Preparing the project foundation for developers

This is the real story of what happens before the first line of code —
and how taking ownership of that phase shaped the success of the entire project.


### 🗣️ 2. Communication & Requirement Gathering — Where Everything Starts
...
Understanding the client’s needs, expectations, limitations, and business goals is what shapes the entire project.

And in this phase, I wasn’t just involved — I was responsible for all of it.
...
### 💬 2.1 Initial Meetings With the Client
...
- Product owners
- Technical contacts on the client’s side
- My own manager
...
### 🧠 2.2 Turning Conversations Into Actual Requirements

From each meeting, I collected every detail — but the important part was transforming all this information into structured, actionable requirements:
...
### 🤝 2.3 My Role as the Bridge Between Worlds
...
👉 Client ↔ Architecture/Integrations
...
### 📌 2.4 Eliminating Ambiguities (The Most Crucial Part)
...
- “How should we behave if the external provider doesn’t respond?”
- “What deadlines must we respect?”
- “Who approves this flow?”
- “Are there internal rules the system must follow?”
...
### 📝 3. Documentation — Turning Information Into a Structured Project
...
And again — I handled this entire phase myself.

### 📚 3.1 Confluence: Building the Knowledge Base
...
### 🧩 3.2 Briefs for Faster Validation
...
### 📃 3.3 Syncing With Client Tools & Azure Docs
...
The team could start coding with full clarity — because I had already structured everything upfront.

### 📌 4. Task Organisation — Turning Requirements Into Actionable Work (Jira)
...
All the task organisation in Jira — from epics to subtasks — was handled by me.

### 🧱 4.1 Structuring the Work in Jira

I transformed the documented requirements into a clean, logical structure:

Epics → big functional blocks
User Stories → specific behaviours or flows
Subtasks → technical actions for developers
...
### 🤝 4.3 Preparing Everything for the Dev Team
...
### 🧠 4.4 Why This Step Was Important
